                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-8-2.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-8-1.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-7-2.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-7-1.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-6-4.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-6-1.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-5-3.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-5-4.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-4-3.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-4-2.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-3-2.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-3-3.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-2-1.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-2-3.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
                                    ...
                                    <div class="airi-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <div class="product-image--holder">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-1-1.jpg"
                                                            alt="Product Image" class="primary-image">
                                                        <img src="{{ asset('frontend_assets') }}/img/products/prod-1-4.jpg"
                                                            alt="Product Image" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="airi-product-action">
