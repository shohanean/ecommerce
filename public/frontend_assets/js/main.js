(function ($) {
    ...
    topBarHeight = $("header .top-bar").elExists()
        ? $("header .top-bar")[0].getBoundingClientRect().height
        : 0;
    mainHeaderHeight = $(".header-inner").elExists()
        ? $(".header-inner")[0].getBoundingClientRect().height
        : 0;
    headerInnerPosition = $(".header-inner").elExists()
        ? $(".header-inner").offset().top
        : "";
    headerTotalHeight = topBarHeight + mainHeaderHeight;
    mobileHeaderHeight = $(".header-mobile__inner").elExists()
        ? $(".header-mobile__inner")[0].getBoundingClientRect().height
        : 0;
    mobileHeaderInnerPosition = $(".header-mobile__inner").elExists()
        ? $(".header-mobile__inner").offset().top
        : "";
    ...
    $(".main-navigation a").each(function () {
        if ($(this).attr("href") === pageUrl || $(this).attr("href") === "") {
            ...
            $('.main-navigation a[href="index.html"]')
                .parent("li")
                .addClass("active");
        }
    });
    ...
    $offcanvasNavSubMenu
        .parent()
        .prepend(
            '<span class="menu-expand"><i class="fa fa-angle-right"></i></span>'
        );
    ...
    function stickySocial(stickyArg) {
        if ($(stickyArg.selector).elExists()) {
            ...
            $(window).on("scroll", function () {
                ...
                if (
                    windowTop >= stickyPosition &&
                    windowTop <= containerHeight
                ) {
                    sticky
                        .addClass("fixed")
                        .css({ left: leftPosition, top: topSpacing });
                } else {
                    sticky
                        .removeClass("fixed")
                        .css({ left: "auto", top: defaultTopSpacing + "px" });
                }
            });
    ...
    videoPopup.magnificPopup({
        type: "iframe",
        closeMarkup:
            '<button type="button" class="custom-close mfp-close"><i class="dl-icon-close mfp-close"></i></button type="button">',
    });
    ...
    $(".product-gallery-image-carousel").slick({
        ...
        arrows: true,
        prevArrow:
            '<span class="slick-btn slick-prev"><i class="dl-icon-left"></i></span>',
        nextArrow:
            '<span class="slick-btn slick-next"><i class="dl-icon-right"></i></span>',
    });
            ...
            $elementCarousel.each(function (index, element) {
                ...
                var $spaceBetween = $options.spaceBetween
                    ...
                    $spaceBetween_xl = $options.spaceBetween_xl
                        ...
                        : 0,
                    $spaceBetween_lg = $options.spaceBetween_lg
                        ? parseInt($options.spaceBetween_lg, 10)
                        : 0,
                ...
                $("body").on(
                    "shown.bs.tab",
                    'a[data-bs-toggle="tab"], a[data-toggle="pill"]',
                    function (e) {
